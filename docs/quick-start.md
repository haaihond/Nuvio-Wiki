...
- **Windows:** Download and run the .msi installer. [Full Guide](installation/windows.md)
...
Use the quickstart tool below if you want Nuvio to install a streaming addon for you. It keeps a compatible metadata addon you already have and only installs Nuvio Catalog when you do not have one.

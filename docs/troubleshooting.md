...
| :--- | :--- |
| **Video Stutters / Buffers** | 1. Ensure a Debrid service is active. <br> 2. Toggle **Hardware Acceleration** in Settings. <br> 3. Check your internet connection. <br> 4. Clear the app's cache. <br> 5. Toggle tunneled playback on/off. <br> 6. Change your AFR settings. <br> 7. Try an external player. <br> 8. Toggle fast startup for subtitles.|

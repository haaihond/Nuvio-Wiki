...
| :--- | :--- |
| **Video Stutters / Buffers** | 1. Ensure a Debrid service is active. <br> 2. Toggle **Hardware Acceleration** in Settings. <br> 3. Check your internet connection. 4. Clear the apps cache. 5. Toggle tunneled playback on/off. 6. Change your AFR settings. 7. Try an external player. |
